...
player_run_anim_R = [pygame.image.load("img/player/Player_Run_R/Player_Run_R0.png"),
...
player_run_anim_L = [pygame.image.load("img/player/Player_Run_L/Player_Run_L0.png"),
...
player_idle_anim_L = [pygame.image.load("img/player/Player_Idle_L/Player_Idle_L0.png"),
...
class Player(pygame.sprite.Sprite):
    def __init__(self, name, x, y, blockers):
        super().__init__()
        self.image = pygame.image.load(f'{name}').convert_alpha()
